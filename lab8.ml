...
let listener1 = add_listener newswire fakeNewsNetwork ;; 
let listener2 = add_listener newswire buzzFake ;;
...
remove_listener newswire listener1 ;;
remove_listener newswire listener2 ;;
...
let receive_report1 str1 = add_listener publish (fun () -> fakeNewsNetwork str) ;;
let receive_report2 str2 = add_listener publish (fun () -> buzzFake str) ;;
